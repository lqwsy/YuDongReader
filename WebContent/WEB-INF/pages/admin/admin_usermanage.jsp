					...
					<li class="tpl-left-nav-item">
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block">
							<li>
								...
								class="active"> <i class="am-icon-angle-right"></i> <span>用户管理</span>
							</a> <a href="${pageContext.request.contextPath}/adminBookManager">
									<i class="am-icon-angle-right"></i> <span>图书管理</span>
							</a>
							</li>
						</ul>
					</li>
						...
						<div class="am-u-sm-12 am-u-md-3">
							<div class="am-form-group">
								<select data-am-selected="{btnSize: &#39;sm&#39;}"
									...
									<option value="option1">超级管理员</option>
									<option value="option2">普通用户</option>
								</select>
							</div>
						</div>
						<div class="am-u-sm-12 am-u-md-3">
