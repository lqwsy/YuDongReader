...
<body style="">
				...
				<div class="outter-wp">
					...
					<div class="forms-main">
						...
						<div class="graph-form">
							<div class="form-body">
								<form
									action="${pageContext.request.contextPath}/updateMyProfile"
									method="post" onSubmit="return check()">
									<div class="form-group">
										<label for="bookName">头像</label><br> <a href="#"
											data-toggle="modal" data-target="#uploadImgModal"> <img
											id="pic-show"
											src="static/img/${sessionScope.cur_user.headImage}"
											alt="点击修改" /> <label>点击修改</label>
										</a>
									</div>
									<div class="form-group">
										<label for="userName">用户名</label> <input type="text"
											class="form-control" name="userName" id="userName"
											value="${sessionScope.cur_user.userName}" readonly="readonly">
									</div>
									<div class="form-group">
										<label for="userNickName">昵称</label> <input type="text"
											class="form-control" name="userNickName" id="userNickName"
											value="${sessionScope.cur_user.userNickName}">
									</div>
	...
	<div class="sidebar-menu">
		...
		<div class="down">
			<a href="${pageContext.request.contextPath}/myProfile"><img
				src="static/img/${sessionScope.cur_user.headImage}"></a> <a
				href="${pageContext.request.contextPath}/myProfile"><span
				class=" name-caret">用户：${sessionScope.cur_user.userName}</span></a>
			<p>昵称：${sessionScope.cur_user.userNickName}</p>
			<ul>
				<li><a class="tooltips"
					href="${pageContext.request.contextPath}/myProfile"><span>个人信息</span><i
